...
namespace HostPluginNamespace\Contracts;
...
abstract class repo
{
    ...
    public function find($count = 1, array $args = array())
    {
    ...
    public function find_connected($connection_type, $id, array $args = array())
    {
        $args = array_merge(array(
